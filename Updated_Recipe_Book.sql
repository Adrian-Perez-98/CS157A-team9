CREATE DATABASE  IF NOT EXISTS `recipe_book` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `recipe_book`;
...
INSERT INTO `grocery_item` VALUES (1,'Ham','deli meat',2.50),(2,'Salami','deli meat',3.00),(3,'Sugar','flavor',5.00),(4,'Lettuce','greens',3.50),(5,'Beets','greens',3.50),(6,'Noodles','pasta',5.00),(7,'Marinara','pasta',5.50),(8,'Chicken','deli meat',10.50),(9,'Lemon','sour',1.00),(10,'Apple','fruit',1.20),(11,'Orange','fruit',1.00),(12,'Banana','fruit',1.30),(13,'Cucumbers','greens',1.50),(14,'Peas','greens',0.75),(15,'Macraoni','pasta',5.00),(16,'Alfredo','pasta',6.00),(17,'Mango','fruit',2.00),(18,'Turkey','deli meat',3.00),(19,'Salt','flavor',4.00),(20,'Pepper','flavor',2.00),(21,'Paprika','flavor',3.00),(22,'Thyme','flavor',5.00);
...
INSERT INTO `grocery_list` VALUES (1,5,'Fruits','Fruit'),(2,4,'Meat','Deli Meat'),(3,8,'Veggies','Greens'),(4,7,'Spaghetti','Pasta'),(5,3,'Spices','flavor');
...
-- Dump completed on 2022-12-09 23:16:49
